...
public class LeaveAppSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    {
        Log.i(Home.Log_Tag, "SyncAdapter | Logic Execution start");

        ContentValues values = new ContentValues();
        values.put(DBContract.LeaveEntry.COL_STATUS, "Re-Testing");

        getContext().getContentResolver().update(DBContract.LeaveEntry.Content_Uri, values, null, null);

        Home.db_data = true;

        Log.i(Home.Log_Tag, "SyncAdapter | Logic Execution complete");
    ...
    private static void onAccountCreated(Account newAccount, Context context)
    {
        ...
        */
                LeaveAppSyncAdapter.configurePeriodicSync(context, SYNC_INTERVAL, SYNC_FLEXTIME);
        /*
